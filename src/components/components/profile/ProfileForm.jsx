...
const ProfileForm = () => {
  ...
  return (
    <div className='col-span-6 w-full max-w-7xl'>
      <form onSubmit={handleSubmit}>
        <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
          ...
          <div className='col-span-full'>
            ...
            <CustomInput cls='mt-2' onChange={handleChange} onBlur={handleBlur} className={`block w-full rounded-md border-0 py-3 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none transition-all focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-lg font-medium sm:leading-6 ${errors.email && touched.email ? 'ring-red-600 ring-[0.15rem]' : ''}`} value={values.email} id='email' placeholder='enter your new email address to update...' />
          </div>
          <div className='col-span-full'>
        ...
        <Button type='submit' className='text-white px-8 py-3 mt-2 bg-gray-800 rounded-lg w-full hover:bg-gray-600 text-lg font-medium disabled:opacity-75' disabled={isSubmitting}>
