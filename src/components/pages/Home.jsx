...
const Home = () => {
  return (
    <Fragment>
      <section className='h-[60vh] lg:h-[calc(100vh-12rem)] mx-auto max-w-5xl md:max-w-7xl lg:max-w-[90rem] xl:max-w-[95rem] grid grid-cols-1 sm:grid-cols-2 gap-24 place-items-center place-content-center px-10'>
